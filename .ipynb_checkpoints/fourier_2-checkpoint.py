...
#setup
mspattern ="bat/rate/sw*brtms.lc"
pathname = Path("~/data/mirror/swift").expanduser()
obsid="00096727251"

filename = list(pathname.joinpath(obsid).rglob(mspattern))
...
n = prev_fast_FFT_len(len(longdatasegment[0]) - int(60 / tb))
